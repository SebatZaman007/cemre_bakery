            ...
            <form action="{{route('portfolio.store')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="portfolio_productname" class="form-control" id="exampleInputEmail1">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Portfolio Rate</label>
                  <input type="text" name="portfolio_rate" class="form-control" id="exampleInputPassword1" >
                </div>
              </div>
              <!-- /.card-body -->
