                    ...
                    <div class="single-widget pr-60">
                        <div class="footer-logo pb-25">
                            <div class="col-md-4 noPadding text-center">
                                <a class="" href="index.html"><img class="img-responsive" src="{{asset('frontend/img/logo/cemrebakerylogo.png')}}" alt="restorant" /></a>
                            </div>
                            <div class="col-md-8 noPadding logo-text">
                                <a class="" href="index.html"><img class="img-responsive" src="{{asset('frontend/img/logo/cemrebakerytextlogo.png')}}" alt="restorant" /></a>
